...
public:
  ObDfo(common::ObIAllocator &allocator) :
    ...
    local_shuffle_id_(common::OB_INVALID_ID)
  {
  }
  ...
  inline void set_local_shuffle_id(uint64_t local_shuffle_id) { local_shuffle_id_ = local_shuffle_id; }
  inline uint64_t get_local_shuffle_id() { return local_shuffle_id_; }
